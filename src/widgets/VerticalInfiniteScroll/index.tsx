import { YStack, isWeb, type TamaguiElement, type YStackProps } from 'tamagui'
...
export function VerticalInfiniteScroll({
  ...
  const containerRefWeb = useRef<TamaguiElement>(null)
  ...
  useEffect(() => {
    ...
    const animate = (currentTime: number) => {
      ...
      if (!isPausedRef.current) {
        ...
        (containerRefWeb.current as HTMLElement)?.style?.setProperty('transform', `translateY(${webTranslateYRef.current}px)`) // 直接操作DOM, 不用更新状态<性能最佳>
      }
