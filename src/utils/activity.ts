...
import type { ResetType, RechargeType, ActivityType } from "~/enums/activity"
...
const previewText_Second_mysteryReward: Recordable = {
	'zh-CN': {
		NONE: '一次性',
		PERIODIC: '循环',
	},
...
/** Preview text second */
const previewText_Second: Recordable = {
	'zh-CN': {
		NONE: '不重置',
		DAILY: '每日重置',
		WEEKLY: '每周重置',
...
const previewText_Third: Recordable = {
	'zh-CN': {
		ABANDONED: '过期作废',
		AUTO: '过期自动发放',
