...
import { useResolveColor } from '~/hooks/theme';
...
export const SkewButton = memo(({
  ...
  return (
    <View items='center' justify='center' position="relative" {...props}>
      <Svg width="100%" height="100%" viewBox="0 0 73 30" fill="none" preserveAspectRatio="none" style={styles.skewSvg}>
        <Defs>
          <LinearGradient 
            id={gradientId}
            x1="-20.2125" 
